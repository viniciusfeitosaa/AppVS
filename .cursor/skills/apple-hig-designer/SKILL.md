...
description: Designs Apple-style iOS/macOS/web interfaces following Human Interface Guidelines with SF typography, system colors, 8pt grid, and HIG components. Use when the user asks for Apple-style UI, HIG-compliant design, iOS/macOS interfaces, SF Symbols, glass effects (if requested), or blending Apple HIG with other aesthetics.
---

# Apple HIG Designer

Professional frontend design skill for interfaces following Apple's Human Interface Guidelines (HIG).

**Source:** [axiaoge2/Apple-Hig-Designer](https://github.com/axiaoge2/Apple-Hig-Designer) (MIT). Cópia no repo: `.cursor/skills/apple-hig-designer/` (Cloud Agents). Global local: `~/.cursor/skills/apple-hig-designer/`.
...
*This skill helps produce interfaces that meet Apple's design standards—cohesive, accessible, and polished.*
